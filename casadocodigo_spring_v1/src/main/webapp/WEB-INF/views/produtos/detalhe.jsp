...
<article id="livro-css-eficiente">
	...
	<section class="buy-options clearfix">
		<!-- Esse form:form já nos fornece o input hidden para não termo o Cross Site Request Forgery, caso não usássemos
				...
				<c:forEach items="${produto.precos}" var="preco">
					<li class="buy-option"><input type="radio" name="tipoPreco"
						...
						checked="checked" /> <label class="variant-label">
							${preco.tipo} </label> <small class="compare-at-price">${preco.valor + 10}</small>
